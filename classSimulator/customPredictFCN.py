...
train_arr = ["Regular/CS107Autumn2017dataset.csv", "Regular/CS107Autumn2018dataset.csv", \
"Regular/CS107Spring2018dataset.csv", "Regular/CS107Winter2018dataset.csv", \
"Regular/CS110Autumn2018dataset.csv", "Regular/CS110Spring2018dataset.csv", \
"Regular/CS161Autumn2017dataset.csv", "Regular/CS161Spring2017dataset.csv", \
"Regular/CS229Autumn2018dataset.csv", "Regular/CS221Autumn2016dataset.csv", \
"Regular/CS221Autumn2017dataset.csv"\
#"Regular/CS224NWinter2018dataset.csv"
]
#test_arr = ["Regular/CS107Spring2017dataset.csv"]
test_arr = ["Custom/CustomCSdataset.csv"]
...
if __name__ == "__main__":
	...
	if (False):
		...
		model.save('Custom/model.h5')  # creates a HDF5 file 'my_model.h5'
		del model  # deletes the existing model
	#modelFile = 'Custom/model.h5'
	#model = model_from_json(open(modelFile).read())
	#model.load_weights(os.path.join(os.path.dirname(modelFile), 'model_weights.h5'))
	model = load_model('Custom/model.h5', custom_objects={'sqHuber': sqHuber})
	...
	plt.xticks([78*x for x in range(12)],["Wk 1","Wk 2","Wk 3","Wk 4","Wk 5","Wk 6", "Wk 7", "Wk 8", "Wk 9", "Wk 10", "Wk 11"])

	plt.show()
	plt.savefig('Custom/CustomPlot.png')
	np.save("Custom/CustomPredictions.npy", yhat)
